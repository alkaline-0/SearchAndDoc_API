...
def create_collection(
    ...
    try: 
        ...
        logger.info(f"Created collection {server_id} with {shards} shards and {replicas} replicas.")
        return True
    except Exception as e:
        logger.error(f"Failed to create collection: {str(e)}", exc_info=True, stack_info=True)
        raise
